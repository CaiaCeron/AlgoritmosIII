...
import com.mycompany.facade.ProdutoFacade;
...
public class ProdutoController implements Serializable {
    ...
    @EJB
    private com.mycompany.facade.ProdutoFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProdutoPK(new com.mycompany.versaobeta.ProdutoPK());
    }
    ...
    public Produto getProduto(com.mycompany.versaobeta.ProdutoPK id) {
    ...
    public static class ProdutoControllerConverter implements Converter {
        ...
        com.mycompany.versaobeta.ProdutoPK getKey(String value) {
            com.mycompany.versaobeta.ProdutoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.versaobeta.ProdutoPK();
            key.setId(Integer.parseInt(values[0]));
            key.setCod(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.mycompany.versaobeta.ProdutoPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getId());
            sb.append(SEPARATOR);
            sb.append(value.getCod());
            return sb.toString();
        }
