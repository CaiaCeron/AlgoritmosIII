...
public class Pais implements Serializable {
    ...
    private Collection<Uf> ufCollection;
    ...
    @XmlTransient
    public Collection<Uf> getUfCollection() {
        return ufCollection;
    }

    public void setUfCollection(Collection<Uf> ufCollection) {
        this.ufCollection = ufCollection;
    }
    ...
    public String toString() {
        return "com.mycompany.versaobeta.models.Pais[ id=" + id + " ]";
    }
